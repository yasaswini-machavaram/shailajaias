        ...
        <div className="p-8 max-w-3xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {['A', 'B', 'C', 'D'].map((label, oIdx) => (
                                    <div key={oIdx} className="flex items-center gap-2">
                                        <button
                                            ...
                                            className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${q.correctIndex === oIdx
                ...
                <div className="flex gap-4">
                    ...
                    >
                        {isSubmitting ? 'Creating...' : `Create Quiz (${questions.length} questions)`}
                    </button>
                    <button
                        type="button"
